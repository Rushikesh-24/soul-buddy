...
const Cursor = () => {
  ...
  useEffect(() => {
    ...
    const attachEventListeners = () => {
      ...
      projects.forEach(project => {
        project.addEventListener("mouseenter", () => handleElementInteraction(6));
        project.addEventListener("mouseleave", () => handleElementInteraction(1));
      });
    };
  ...
  return (
    <div
      id="custom-cursor"
      ref={cursorRef}
      className={`fixed top-0 left-0 size-[20px] rounded-full pointer-events-none z-[9999999] mix-blend-difference p-2 sm:flex justify-center items-center bg-white transition-opacity ${
